function [t,y,bodies]=solar_system02(varargin)
% calculate the positions and velocities of planets in the solar system
...
bodies={'Sun','Mercury','Venus','Earth','Mars','Jupiter','Saturn','Uranus','Neptune','Pluto','Black hole'};

% Mean distance from the sun
meandist=[7e8 5.79e10 1.082e11 1.496e11 2.279e11 7.783e11 1.426e12 2.871e12 4.497e12 5.914e12 sqrt(x(end).^2+y(end).^2+z(end).^2)];
