...
Cow.prototype.burp = function() {
	...
	this.raiseHead(500);
	this._timers.push(setTimeout(startled, 500));
	this._timers.push(setTimeout(burping, 1000));
	this._timers.push(setTimeout(headLowered, 2500));
	this._timers.push(setTimeout(destartled, 2500));
	// Total time 2500 ms
	
	// Loop the animation
	this._timers.push(setTimeout( doBurp, this.randomFrequency ));
}
...
Cow.prototype.isStartled = function() {
	return this._isStartled;
}
Cow.prototype.setStartled = function( isStartled ) {
	if (this.destroyed) { return; }
	this._isStartled = isStartled;
...
Cow.prototype.destroy = function() {
	...
	if (this.cowHead) { this.cowHead.stop(); }
	if (this.cowJaw) { this.cowJaw.stop(); }
	if (this.burpCloud) { this.burpCloud.stop(); }
	this.cow.remove();
}
